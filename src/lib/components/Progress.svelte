<script>
  ...
  function mouseDown(ev) {
    ...
    value = _value
    dx = ev.offsetX
    input.dispatchEvent(new CustomEvent('mousedown', { detail: _value }))
  }
  ...
  function mouseMove(ev) {
    ...
    value = _value
    input.dispatchEvent(new CustomEvent('mousemove', { detail: value }))
  }
  ...
  function mouseUp() {
    if (startMove) {
      startMove = false
      dx = 0
      input.dispatchEvent(new CustomEvent('mouseup', { detail: value }))
    }
  }
